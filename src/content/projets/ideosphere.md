...
- **Engagement accru** : les contributeurs deviennent des ambassadeurs de la liste
...
<div class="grid md:grid-cols-2 gap-6 my-8">
    <img src="https://placehold.co/600x400/fdfaf7/A37A55?text=Interface+Fork" alt="Interface de fork" class="rounded-lg w-full">
    <img src="https://placehold.co/600x400/fdfaf7/A37A55?text=Débat+Proposition" alt="Débat sur proposition" class="rounded-lg w-full">
    <img src="https://placehold.co/600x400/fdfaf7/A37A55?text=Timeline" alt="Timeline des contributions" class="rounded-lg w-full">
    <img src="https://placehold.co/600x400/fdfaf7/A37A55?text=Dashboard" alt="Dashboard liste" class="rounded-lg w-full">
</div>

## Vous voulez tester IdeoSphere ?
